...
//   final _udyamTextController = TextEditingController();
//   final _udyamInputFocusNode = FocusNode();
//   final _cancelToken = CancelToken();

//   bool _isError = false;
//   bool _verifyingDetails = false;

//   void _verifyUdyam() async {
//     if (_verifyingDetails) {
//       return;
//     }

//     setState(() {
//       _verifyingDetails = true;
//     });

//     var response = await ref
//         .read(signupStateProvider.notifier)
//         .verifyUdyamNumber(_udyamTextController.text, _cancelToken);

//     if (!mounted) return;

//     setState(() {
//       _verifyingDetails = false;
//     });
...
//       if (RegexProvider.udyamRegex.hasMatch(_udyamTextController.text)) {
//         _udyamInputFocusNode.unfocus();
//       }
//     });
//     super.initState();
//   }
...
//   @override
//   void dispose() {
//     _udyamInputFocusNode.dispose();
//     _udyamTextController.dispose();
//     _cancelToken.cancel();
//     super.dispose();
//   }
...
//                       child: Text(
//                         "Enter your Udyog Aadhar Memorandum (MSME Number) to verify your msme.",
//                         style: TextStyle(
//                           fontFamily: fontFamily,
...
//                         maxLength: 20,
//                         controller: _udyamTextController,
//                         onChanged: (val) {
//                           setState(() {
//                             _isError = false;
//                           });
...
//                         focusNode: _udyamInputFocusNode,
//                         inputFormatters: [UpperCaseTextInputFormatter()],
//                         decoration: InputDecoration(
//                           counterText: "",
//                           hintText: 'Udyam Number',
//                           contentPadding:
...
//                             if (!RegexProvider.udyamRegex
//                                 .hasMatch(_udyamTextController.text)) return;
//                             _verifyUdyam();
//                           },
//                           child: Container(
...
//                             decoration: BoxDecoration(
//                               color: RegexProvider.udyamRegex
//                                       .hasMatch(_udyamTextController.text)
//                                   ? Theme.of(context).colorScheme.primary
