...
//         .verifyGSTOTP(_otpTextInputController.text, _cancelToken);
...
//     if (response.success) {
//       context.go(AppRoutes.signup_fetching_gst_details);
//       return;
//     }
...
//   Future<void> _resendGstOtp() async {
...
//     var response = await ref
//         .read(signupStateProvider.notifier)
//         .sendGSTOTP(ref.read(signupStateProvider).gstUsername, _cancelToken);
...
//                       child: Text(
//                         "OTP sent to your GST registered mobile number",
//                         style: TextStyle(
//                           fontFamily: fontFamily,
