...
class InvoiceLoanAllSupportTickets extends ConsumerStatefulWidget {
  const InvoiceLoanAllSupportTickets({super.key});

  @override
  ConsumerState<InvoiceLoanAllSupportTickets> createState() =>
      _InvoiceLoanAllSupportTicketsState();
}

class _InvoiceLoanAllSupportTicketsState
    extends ConsumerState<InvoiceLoanAllSupportTickets> {
