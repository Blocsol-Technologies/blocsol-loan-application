...
class InvoiceLoanConfirm01Error extends ConsumerStatefulWidget {
  const InvoiceLoanConfirm01Error({super.key});

  @override
  ConsumerState<InvoiceLoanConfirm01Error> createState() =>
      _InvoiceLoanConfirm01ErrorState();
}

class _InvoiceLoanConfirm01ErrorState
    extends ConsumerState<InvoiceLoanConfirm01Error> {
  @override
