...
class InvoiceLoanInit01Error extends ConsumerStatefulWidget {
  const InvoiceLoanInit01Error({super.key});

  @override
  ConsumerState<InvoiceLoanInit01Error> createState() =>
      _InvoiceLoanInit01ErrorState();
}

class _InvoiceLoanInit01ErrorState
    extends ConsumerState<InvoiceLoanInit01Error> {
  @override
