...
class InvoiceLoanInit03Error extends ConsumerStatefulWidget {
  const InvoiceLoanInit03Error({super.key});

  @override
  ConsumerState<InvoiceLoanInit03Error> createState() =>
      _InvoiceLoanInit03ErrorState();
}

class _InvoiceLoanInit03ErrorState
    extends ConsumerState<InvoiceLoanInit03Error> {
  @override
