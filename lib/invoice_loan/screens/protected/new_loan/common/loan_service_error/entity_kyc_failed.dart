...
class InvoiceLoanEntityKycFailed extends ConsumerStatefulWidget {
  const InvoiceLoanEntityKycFailed({super.key});

  @override
  ConsumerState<InvoiceLoanEntityKycFailed> createState() =>
      _InvoiceLoanEntityKycFailedState();
}

class _InvoiceLoanEntityKycFailedState
    extends ConsumerState<InvoiceLoanEntityKycFailed> {
  final _cancelToken = CancelToken();
  bool _refetchingEntityKycUrl = false;
