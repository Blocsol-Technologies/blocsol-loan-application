...
class InvoiceLoanInit02Error extends ConsumerStatefulWidget {
  const InvoiceLoanInit02Error({super.key});

  @override
  ConsumerState<InvoiceLoanInit02Error> createState() =>
      _InvoiceLoanInit02ErrorState();
}

class _InvoiceLoanInit02ErrorState
    extends ConsumerState<InvoiceLoanInit02Error> {
  @override
