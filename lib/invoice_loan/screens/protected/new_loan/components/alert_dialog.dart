...
class NewLoanAlertDialog extends ConsumerStatefulWidget {
  final String text;
  ...
  @override
  ConsumerState<NewLoanAlertDialog> createState() => _NewLoanAlertDialogState();
}

class _NewLoanAlertDialogState extends ConsumerState<NewLoanAlertDialog> {
