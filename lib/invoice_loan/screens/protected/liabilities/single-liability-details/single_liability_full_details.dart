                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          itemCount: selectedLiability
                              .offerDetails.quoteDetails.breakup.length,
                          itemBuilder: (ctx, i) {
                            var selectedQuoteBreakup = selectedLiability
                                .offerDetails.quoteDetails.breakup[i];
                            return SizedBox(
                              width: width,
                              child: Column(
                                children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Text(
                                    selectedLiability.offerDetails.lateCharge,
                                    softWrap: true,
                                    textAlign: TextAlign.end,
                                    style: TextStyle(
                                      fontFamily: fontFamily,
                                ...
                                Text(
                                  selectedLiability.offerDetails
                                      .getNumericalValOrDefault(
                                          selectedLiability
                                              .offerDetails.prepaymentPenalty),
                                  style: TextStyle(
                                    fontFamily: fontFamily,
                                    fontSize: AppFontSizes.b2,
                                    fontWeight: AppFontWeights.bold,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  selectedLiability
                                      .offerDetails.contactInfo.contactNumber,
                                  style: TextStyle(
                                    fontFamily: fontFamily,
                                    fontSize: AppFontSizes.b2,
                                    fontWeight: AppFontWeights.bold,
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      ref.read(routerProvider).push(
                                          InvoiceLoanLiabilitiesRouter
                                              .general_webview,
                                          extra: selectedLiability.offerDetails
                                              .contactInfo.customerSupportLink);
                                    },
                                    child: Container(
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    selectedLiability
                                        .offerDetails.lspContactInfo.address,
                                    softWrap: true,
                                    textAlign: TextAlign.end,
                                    style: TextStyle(
                                      fontFamily: fontFamily,
