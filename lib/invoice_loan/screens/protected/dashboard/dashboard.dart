...
import 'package:blocsol_loan_application/invoice_loan/state/user/user.dart';
...
class InvoiceLoanDashboard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InvoiceLoanDashboard> createState() => _UserHomeState();
}

class _UserHomeState extends ConsumerState<InvoiceLoanDashboard> {
  ...
  Future<void> _handleRefresh() async {
    if (ref.read(userDetailsProvider).fetchingData) {
      return;
    }
...
// class PreviousJourneyAlert extends StatelessWidget {
//   const PreviousJourneyAlert({super.key});
