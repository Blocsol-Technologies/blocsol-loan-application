...
//       );
//     } catch (e, stackTrace) {
//       print("error occured when parsing loan details ${e}");
...
//     for (var payment in loanPayments.paymentDetails) {
//       print("payment type is ${payment.type} and status is ${payment.status}");
...
//     print("amount paid is ${amountPaid}");
...
//         path: "lib/state/user/borrower/old_loans/old_loans_state.dart",
