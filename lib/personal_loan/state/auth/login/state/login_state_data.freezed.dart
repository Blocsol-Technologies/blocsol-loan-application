...
abstract class $LoginStateDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String pan, String phoneNumber});
}
...
class _$LoginStateDataImpl implements _LoginStateData {
  const _$LoginStateDataImpl({required this.pan, required this.phoneNumber});
  ...
  @override
  String toString() {
    return 'LoginStateData(pan: $pan, phoneNumber: $phoneNumber)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, pan, phoneNumber);
...
abstract class _LoginStateData implements LoginStateData {
  const factory _LoginStateData(
      ...
      required final String phoneNumber}) = _$LoginStateDataImpl;
