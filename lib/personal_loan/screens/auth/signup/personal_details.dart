// import 'package:blocsol_personal_credit/screens/personal_credit/auth/signup/utils.dart';
...
//     if (_verifyingUdyam || ref.read(signupStateProvider).udyamValidated) return;
...
//     if (ref.read(signupStateProvider).udyamValidationRequired &&
//         !ref.read(signupStateProvider).udyamValidated) {
//       final snackBar = SnackBar(
//         elevation: 0,
//         behavior: SnackBarBehavior.floating,
//         backgroundColor: Colors.transparent,
...
//     if (!ref.read(signupStateProvider).personalDetailsValidated) {
...
//     if (response.success) {
//       context.go(AppRoutes.pc_signup_password);
//       return;
//     }
...
//     final signupStateRef = ref.watch(signupStateProvider);
