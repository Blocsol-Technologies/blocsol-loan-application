...
class PersonalLoanOnInit03Error extends ConsumerStatefulWidget {
  const PersonalLoanOnInit03Error({super.key});

  @override
  ConsumerState<PersonalLoanOnInit03Error> createState() =>
      _PersonalLoanOnInit03ErrorState();
}

class _PersonalLoanOnInit03ErrorState
    extends ConsumerState<PersonalLoanOnInit03Error> {
  @override
