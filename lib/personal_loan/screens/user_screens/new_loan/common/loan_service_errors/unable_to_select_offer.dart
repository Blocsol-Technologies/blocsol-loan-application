...
class PersonalLoanUnableToSelectOffer extends ConsumerStatefulWidget {
  const PersonalLoanUnableToSelectOffer({super.key});

  @override
  ConsumerState<PersonalLoanUnableToSelectOffer> createState() =>
      _PersonalLoanUnableToSelectOfferState();
}

class _PersonalLoanUnableToSelectOfferState
    extends ConsumerState<PersonalLoanUnableToSelectOffer> {
  @override
