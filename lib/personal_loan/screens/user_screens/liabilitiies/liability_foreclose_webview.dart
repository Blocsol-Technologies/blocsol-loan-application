...
class PCLiabilityForeclosureWebview extends ConsumerStatefulWidget {
  final String url;
  const PCLiabilityForeclosureWebview({super.key, required this.url});

  @override
  ConsumerState<PCLiabilityForeclosureWebview> createState() =>
      _PCLiabilityForeclosureWebviewState();
}

class _PCLiabilityForeclosureWebviewState
    extends ConsumerState<PCLiabilityForeclosureWebview> {
